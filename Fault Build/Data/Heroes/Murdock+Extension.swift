...
extension Murdock: Hero {
    var name: String {
        get {
            return Heroes.murdock.name
        }
    }
    
    var iconURL: String {
        return "https://api.playfault.com/imagecdn/portraits/8.jpg"
    ...
    var bannerName: String {
        return "Murdock_banner"
        //"https://global-uploads.webflow.com/5d44771a95c1f5121689f944/5eb614cf8205003bebdca2a3_T_MurdockDefault_Portrait.jpg"
    }
    
    var eAbilityImageURL: String {
        return "https://api.playfault.com/imagecdn/abilities/Murdock/E.png"
    }
    
    var lmbAbilityImageURL: String {
        return "https://api.playfault.com/imagecdn/abilities/Murdock/LMB.png"
    }
    
    var pAbilityImageURL: String {
        return "https://api.playfault.com/imagecdn/abilities/Murdock/P.png"
    }
    
    var qAbilityImageURL: String {
        return "https://api.playfault.com/imagecdn/abilities/Murdock/Q.png"
    }
    
    var rAbilityImageURL: String {
        return "https://api.playfault.com/imagecdn/abilities/Murdock/R.png"
    }
...
extension MurdockPAbility: Ability {
    func getName() -> String {
        return self.name
    }
...
extension MurdockQAbility: Ability {
    func getName() -> String {
        return self.name
    }
    ...
    func getDetails() -> String {
        ...
        details.append("Max Bounce Range: \(self.angle)\n")
        details.append("Radius: \(self.range)\n")
        details.append("Minion Damage Reduction: \(self.physArmPCTRed)\n")
        details.append("Recovery Time: \(self.reductionDuration)\n")
        details.append("Scaling Factor: \(self.scalingFactor)")
        return details
    }
}

extension MurdockEAbility: Ability {
    func getName() -> String {
        return self.name
    }
    ...
    func getDetails() -> String {
        ...
        details.append("Max Traps Deployed: \(self.maxTrapsDeployed)\n")
...
extension MurdockRAbility: Ability {
    func getName() -> String {
        return self.name
    }
    ...
    func getDetails() -> String {
        ...
        details.append("Cooldown: \(self.cooldown)\n")
        details.append("Cast Time: \(self.castTime)\n")
        details.append("Max Lifetime: \(self.readyTime)\n")
...
extension MurdockRMBAbility: Ability {
    func getName() -> String {
        return self.name
    }
    ...
    func getDetails() -> String {
        ...
        details.append("Resource Cost: \(self.resourceCost)\n")
        details.append("Cooldown: \(self.cooldown)\n")
        details.append("Cast Time: \(self.duration)\n")
        details.append("Horizontal Distance: \(self.length)\n")
        details.append("Vertical Distance: \(self.speed)\n")
        details.append("Move Speed: \(self.width)")
        return details
    }
}
